...
\begin{center}
\fbox{\parbox{8cm}{\url {https://github.com/dudekulauseni123/Module1/blob/main/iot/codes/setup/src/main.cpp}}}
\end{center}
\begin{center}
\end{center}
\begin{lstlisting}
svn co https://github.com/dudekulauseni123/Module1/trunk/Iot/codes/setup
cd  setup
pio run
pio run -t upload
\end{lstlisting}
...
mkdir iot
svn co https://github.com/dudekulauseni123/Module1/trunk/Iot/codes/ota
cd codes
\end{lstlisting}
\item Assuming that the username is $<<$hussain$>>$ and password is $<<$hussain@123$>>$, Make connections to the seven-segment display and IC 7447 and flash the following code wirelessly
\begin{center}
\fbox{\parbox{8cm}{\url{https://github.com/dudekulauseni123/Module1/blob/main/Iot/codes/ota/src/main.cpp}}}
\end{center}
through 
\begin{lstlisting}
pio run 
